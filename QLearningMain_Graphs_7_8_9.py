...
def main():
    ...
    if SAVE_AGENT_ONE == True:
        with open('PointDictBasic_Graph_7_8_9.pickle', 'wb') as handle:
            pickle.dump(point_dict_basic, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListBasic_Graph_7_8_9.pickle', 'wb') as handle:
            pickle.dump(point_list_basic, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierBasic_Graph_7_8_9.pickle', 'wb') as handle:
            pickle.dump(specifier_basic, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointDictConsecutive_Graph_7_8_9.pickle', 'wb') as handle:
            pickle.dump(point_dict_consecutive, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListConsecutive_Graph_7_8_9.pickle', 'wb') as handle:
            pickle.dump(point_list_consecutive, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierConsecutive_Graph_7_8_9.pickle', 'wb') as handle:
            pickle.dump(specifier_consecutive, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

    if LOAD_AGENT_ONE == True:
        try:
            with open('PointDictBasic_Graph_7_8_9.pickle', 'rb') as handle:
                point_dict_basic = pickle.load(handle)
                handle.close()

            with open('PointListBasic_Graph_7_8_9.pickle', 'rb') as handle:
                point_list_basic = pickle.load(handle)
                handle.close()

            with open('SpecifierBasic_Graph_7_8_9.pickle', 'rb') as handle:
                specifier_basic = pickle.load(handle)
                handle.close()

            with open('PointDictConsecutive_Graph_7_8_9.pickle', 'rb') as handle:
                point_dict_consecutive = pickle.load(handle)
                handle.close()

            with open('PointListConsecutive_Graph_7_8_9.pickle', 'rb') as handle:
                point_list_consecutive = pickle.load(handle)
                handle.close()

            with open('SpecifierConsecutive_Graph_7_8_9.pickle', 'rb') as handle:
    ...
    if SAVE_AGENT_TWO == True:
        with open('PointDictBasic_Graph_7_8_9_AGENT_TWO.pickle', 'wb') as handle:
            pickle.dump(point_dict_basic_agent_two, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListBasic_Graph_7_8_9_AGENT_TWO.pickle', 'wb') as handle:
            pickle.dump(point_list_basic_agent_two, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierBasic_Graph_7_8_9_AGENT_TWO.pickle', 'wb') as handle:
            pickle.dump(specifier_basic_agent_two, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointDictConsecutive_Graph_7_8_9_AGENT_TWO.pickle', 'wb') as handle:
            pickle.dump(point_dict_consecutive_agent_two, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListConsecutive_Graph_7_8_9_AGENT_TWO.pickle', 'wb') as handle:
            pickle.dump(point_list_consecutive_agent_two, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierConsecutive_Graph_7_8_9_AGENT_TWO.pickle', 'wb') as handle:
            pickle.dump(specifier_consecutive_agent_two, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

    if LOAD_AGENT_TWO == True:
        try:
            with open('PointDictBasic_Graph_7_8_9_AGENT_TWO.pickle', 'rb') as handle:
                point_dict_basic_agent_two = pickle.load(handle)
                handle.close()

            with open('PointListBasic_Graph_7_8_9_AGENT_TWO.pickle', 'rb') as handle:
                point_list_basic_agent_two = pickle.load(handle)
                handle.close()

            with open('SpecifierBasic_Graph_7_8_9_AGENT_TWO.pickle', 'rb') as handle:
                specifier_basic_agent_two = pickle.load(handle)
                handle.close()

            with open('PointDictConsecutive_Graph_7_8_9_AGENT_TWO.pickle', 'rb') as handle:
                point_dict_consecutive_agent_two = pickle.load(handle)
                handle.close()

            with open('PointListConsecutive_Graph_7_8_9_AGENT_TWO.pickle', 'rb') as handle:
                point_list_consecutive_agent_two = pickle.load(handle)
                handle.close()

            with open('SpecifierConsecutive_Graph_7_8_9_AGENT_TWO.pickle', 'rb') as handle:
    ...
    if SAVE_AGENT_THREE == True:
        with open('PointDictBasic_Graph_7_8_9_AGENT_THREE.pickle', 'wb') as handle:
            pickle.dump(point_dict_basic_agent_three, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListBasic_Graph_7_8_9_AGENT_THREE.pickle', 'wb') as handle:
            pickle.dump(point_list_basic_agent_three, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierBasic_Graph_7_8_9_AGENT_THREE.pickle', 'wb') as handle:
            pickle.dump(specifier_basic_agent_three, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointDictConsecutive_Graph_7_8_9_AGENT_THREE.pickle', 'wb') as handle:
            pickle.dump(point_dict_consecutive_agent_three, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListConsecutive_Graph_7_8_9_AGENT_THREE.pickle', 'wb') as handle:
            pickle.dump(point_list_consecutive_agent_three, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierConsecutive_Graph_7_8_9_AGENT_THREE.pickle', 'wb') as handle:
            pickle.dump(specifier_consecutive_agent_three, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

    if LOAD_AGENT_THREE == True:
        try:
            with open('PointDictBasic_Graph_7_8_9_AGENT_THREE.pickle', 'rb') as handle:
                point_dict_basic_agent_three = pickle.load(handle)
                handle.close()

            with open('PointListBasic_Graph_7_8_9_AGENT_THREE.pickle', 'rb') as handle:
                point_list_basic_agent_three = pickle.load(handle)
                handle.close()

            with open('SpecifierBasic_Graph_7_8_9_AGENT_THREE.pickle', 'rb') as handle:
                specifier_basic_agent_three = pickle.load(handle)
                handle.close()

            with open('PointDictConsecutive_Graph_7_8_9_AGENT_THREE.pickle', 'rb') as handle:
                point_dict_consecutive_agent_three = pickle.load(handle)
                handle.close()

            with open('PointListConsecutive_Graph_7_8_9_AGENT_THREE.pickle', 'rb') as handle:
                point_list_consecutive_agent_three = pickle.load(handle)
                handle.close()

            with open('SpecifierConsecutive_Graph_7_8_9_AGENT_THREE.pickle', 'rb') as handle:
    ...
    if SAVE_AGENT_FOUR == True:
        with open('PointDictBasic_Graph_7_8_9_AGENT_FOUR.pickle', 'wb') as handle:
            pickle.dump(point_dict_basic_agent_four, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListBasic_Graph_7_8_9_AGENT_FOUR.pickle', 'wb') as handle:
            pickle.dump(point_list_basic_agent_four, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierBasic_Graph_7_8_9_AGENT_FOUR.pickle', 'wb') as handle:
            pickle.dump(specifier_basic_agent_four, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointDictConsecutive_Graph_7_8_9_AGENT_FOUR.pickle', 'wb') as handle:
            pickle.dump(point_dict_consecutive_agent_four, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListConsecutive_Graph_7_8_9_AGENT_FOUR.pickle', 'wb') as handle:
            pickle.dump(point_list_consecutive_agent_four, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierConsecutive_Graph_7_8_9_AGENT_FOUR.pickle', 'wb') as handle:
            pickle.dump(specifier_consecutive_agent_four, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

    if LOAD_AGENT_FOUR == True:
        try:
            with open('PointDictBasic_Graph_7_8_9_AGENT_FOUR.pickle', 'rb') as handle:
                point_dict_basic_agent_four = pickle.load(handle)
                handle.close()

            with open('PointListBasic_Graph_7_8_9_AGENT_FOUR.pickle', 'rb') as handle:
                point_list_basic_agent_four = pickle.load(handle)
                handle.close()

            with open('SpecifierBasic_Graph_7_8_9_AGENT_FOUR.pickle', 'rb') as handle:
                specifier_basic_agent_four = pickle.load(handle)
                handle.close()

            with open('PointDictConsecutive_Graph_7_8_9_AGENT_FOUR.pickle', 'rb') as handle:
                point_dict_consecutive_agent_four = pickle.load(handle)
                handle.close()

            with open('PointListConsecutive_Graph_7_8_9_AGENT_FOUR.pickle', 'rb') as handle:
                point_list_consecutive_agent_four = pickle.load(handle)
                handle.close()

            with open('SpecifierConsecutive_Graph_7_8_9_AGENT_FOUR.pickle', 'rb') as handle:
    ...
    if SAVE_AGENT_FIVE == True:
        with open('PointDictBasic_Graph_7_8_9_AGENT_FIVE.pickle', 'wb') as handle:
            pickle.dump(point_dict_basic_agent_five, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListBasic_Graph_7_8_9_AGENT_FIVE.pickle', 'wb') as handle:
            pickle.dump(point_list_basic_agent_five, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierBasic_Graph_7_8_9_AGENT_FIVE.pickle', 'wb') as handle:
            pickle.dump(specifier_basic_agent_five, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointDictConsecutive_Graph_7_8_9_AGENT_FIVE.pickle', 'wb') as handle:
            pickle.dump(point_dict_consecutive_agent_five, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('PointListConsecutive_Graph_7_8_9_AGENT_FIVE.pickle', 'wb') as handle:
            pickle.dump(point_list_consecutive_agent_five, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

        with open('SpecifierConsecutive_Graph_7_8_9_AGENT_FIVE.pickle', 'wb') as handle:
            pickle.dump(specifier_consecutive_agent_five, handle, protocol=pickle.HIGHEST_PROTOCOL)
            handle.close()

    if LOAD_AGENT_FIVE == True:
        try:
            with open('PointDictBasic_Graph_7_8_9_AGENT_FIVE.pickle', 'rb') as handle:
                point_dict_basic_agent_five = pickle.load(handle)
                handle.close()

            with open('PointListBasic_Graph_7_8_9_AGENT_FIVE.pickle', 'rb') as handle:
                point_list_basic_agent_five = pickle.load(handle)
                handle.close()

            with open('SpecifierBasic_Graph_7_8_9_AGENT_FIVE.pickle', 'rb') as handle:
                specifier_basic_agent_five = pickle.load(handle)
                handle.close()

            with open('PointDictConsecutive_Graph_7_8_9_AGENT_FIVE.pickle', 'rb') as handle:
                point_dict_consecutive_agent_five = pickle.load(handle)
                handle.close()

            with open('PointListConsecutive_Graph_7_8_9_AGENT_FIVE.pickle', 'rb') as handle:
                point_list_consecutive_agent_five = pickle.load(handle)
                handle.close()

            with open('SpecifierConsecutive_Graph_7_8_9_AGENT_FIVE.pickle', 'rb') as handle:
